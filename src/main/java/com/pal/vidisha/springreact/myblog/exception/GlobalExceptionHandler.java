package com.pal.vidisha.springreact.myblog.exception;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<APIError> validationException(ValidationException ex, HttpServletRequest request){
        ...
        return new ResponseEntity<>(APIError.builder()
                ...
                .customMessage("Request is not valid." +  ex.getMessage())
                .build(), HttpStatus.BAD_REQUEST);
    }

    @ExceptionHandler({Exception.class})
    public ResponseEntity<APIError> validationException(Exception ex, HttpServletRequest request){
